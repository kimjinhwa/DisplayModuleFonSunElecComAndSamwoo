...
static BatOid sFixed[] = {
    ...
    {".1.3.6.1.2.1.32.1.6.4.0", 0, 12, K_BIT, 0, 0},
    {".1.3.6.1.2.1.32.1.6.5.0", 0, 12, K_BIT, 1, 0},
    {".1.3.6.1.2.1.32.1.6.1.0", 0, 13, K_U16, -1, 0},
    {".1.3.6.1.2.1.32.1.10.0", 0, 14, K_U16, -1, 0},
    {".1.3.6.1.2.1.32.1.6.2.0", 0, 15, K_U16, -1, 0},
    {".1.3.6.1.2.1.32.1.15.0", 0, 16, K_U16, -1, 0},
    ...
    {".1.3.6.1.2.1.32.2.6.4.0", 1, 12, K_BIT, 0, 0},
    {".1.3.6.1.2.1.32.2.6.5.0", 1, 12, K_BIT, 1, 0},
    {".1.3.6.1.2.1.32.2.6.1.0", 1, 13, K_U16, -1, 0},
    {".1.3.6.1.2.1.32.2.10.0", 1, 14, K_U16, -1, 0},
    {".1.3.6.1.2.1.32.2.6.2.0", 1, 15, K_U16, -1, 0},
    {".1.3.6.1.2.1.32.2.15.0", 1, 16, K_U16, -1, 0},
};
...
void snmpBatteryRefresh()
{
  ...
  for (uint8_t p = 0; p < 2; ++p)
  {
    ...
    {
      sCellVal[p][i] = (int)samwooReg(p, (uint16_t)(17 + i));
    }
    for (uint8_t i = 0; i < 8; ++i)
    {
      sTempVal[p][i] = (int)(int16_t)samwooReg(p, (uint16_t)(32 + i));
    }
  }
}
